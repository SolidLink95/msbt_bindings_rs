...
///
/// Verifies whether the supplied value is a valid bit mask of the form
/// 0b00...0011...11. Both edge cases of all zeros and all ones are considered
/// valid masks, too.
///
...
///
/// Reinterpret objects of one type as another by bit-casting between object
/// representations.
///
/// @remark This is the example implementation of std::bit_cast which is to be
/// included
///         in C++2a. See
///         http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0476r2.html
///         for more details. The only difference is this variant is not
///         constexpr, as the mechanism for bit_cast requires a compiler
///         built-in to have that quality.
///
...
// structs Conversion constructor and operator= provided for a convenient
